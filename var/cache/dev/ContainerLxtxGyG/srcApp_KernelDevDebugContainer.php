...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KedJ-bbJj+', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N54A4uYlMB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QZS0e3L+Qk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderc66b0 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerfca53 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9f22d = [
        
    ];

    public function getConnection()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getConnection', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getMetadataFactory', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getExpressionBuilder', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'beginTransaction', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getCache', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getCache();
    }

    public function transactional($func)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'transactional', array('func' => $func), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->transactional($func);
    }

    public function commit()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'commit', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->commit();
    }

    public function rollback()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'rollback', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getClassMetadata', array('className' => $className), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'createQuery', array('dql' => $dql), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'createNamedQuery', array('name' => $name), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'createQueryBuilder', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'flush', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'clear', array('entityName' => $entityName), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->clear($entityName);
    }

    public function close()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'close', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->close();
    }

    public function persist($entity)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'persist', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'remove', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'refresh', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'detach', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'merge', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getRepository', array('entityName' => $entityName), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'contains', array('entity' => $entity), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getEventManager', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getConfiguration', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'isOpen', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getUnitOfWork', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getProxyFactory', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'initializeObject', array('obj' => $obj), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'getFilters', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'isFiltersStateClean', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'hasFilters', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return $this->valueHolderc66b0->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerfca53 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderc66b0) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderc66b0 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderc66b0->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, '__get', ['name' => $name], $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        if (isset(self::$publicProperties9f22d[$name])) {
            return $this->valueHolderc66b0->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderc66b0;
    ...
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;
    ...
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, '__isset', array('name' => $name), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;
    ...
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, '__unset', array('name' => $name), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;
    ...
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, '__clone', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        $this->valueHolderc66b0 = clone $this->valueHolderc66b0;
    }

    public function __sleep()
    {
        $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, '__sleep', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;

        return array('valueHolderc66b0');
    }
    ...
    {
        $this->initializerfca53 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerfca53;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerfca53 && ($this->initializerfca53->__invoke($valueHolderc66b0, $this, 'initializeProxy', array(), $this->initializerfca53) || 1) && $this->valueHolderc66b0 = $valueHolderc66b0;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderc66b0;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderc66b0;
    }
}
